...
<script type="text/javascript"  charset="utf-8" src="/js/common/jquery-1.11.0.min.js"></script>
...
<script type="text/javascript" >
	...
	function fn_onload(){
		...
		if(parent.document.getElementById("executionImageImg") != null &&
		   parent.document.getElementById("layerDiv") != null){
			...
			var htmlStr = "Unexpected Exception<br>";
	...
	String omsg = exception.getMessage();
