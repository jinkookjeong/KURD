...
/**
 * 입력받은 url 의 html 을 파싱 :  read Html Parsing
 * @methodName : readHtmlParsing
 * @return     : void
 * @param str
 */
...
private class CallbackHandler extends HTMLEditorKit.ParserCallback	{
	...
	/**
	 * 환율계산 : Exchange calculated
	 * @methodName : getEhgtCalc
	 * @return     : String
	 * @param srcType
	 * @param srcAmount
	 * @param cnvrType
