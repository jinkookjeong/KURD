...
public class NumberUtil {
    ...
    /**
     * <p>특정숫자 집합에서 랜덤 숫자를 구하는 기능으로  시작숫자와 종료숫자 사이에서 구한 랜덤 숫자를 반환한다.</p>
     *
     * @param startNum  시작숫자
     * @param endNum  종료숫자
     * @return 랜덤숫자
    ...
    /**
     * <p>특정 숫자 집합에서 특정 숫자가 있는지 체크한다.</p>
     * <pre>12345678에서 7이 있는지 없는지 체크하는 기능을 제공함</pre>
     *
    ...
    /**
     * <p>숫자타입을 문자열로 변환한다.</p>
     * <pre>기능 숫자 20081212를 문자열 '20081212'로 변환하는 기능</pre>
     *
     * @param srcNumber 숫자
     * @return 문자열
     * @exception MyException
    ...
    /**
     * <p>숫자타입을 데이트 타입으로 변환한다.</p>
     * <pre>
     * 숫자 20081212-> Date Type  '2008-12-12'로 변환하는 기능
     * </pre>
     * @param srcNumber - 숫자
     * @return String
     * @exception MyException
    ...
    /**
     * <p>체크할 문자열 중에서 숫자가 포함되어 있는지 체크하는 기능이다.<br>
    ...
    /**
     * <p>특정숫자를 다른 숫자로 치환하는 기능 숫자 12345678에서 123를 999로 변환하는 기능을 제공(99945678)</p>
     *
    ...
    /**
     * <p>특정숫자가 실수인지, 정수인지, 음수인지 체크하는 기능 123이 실수인지, 정수인지, 음수인지 체크하는 기능을 제공한다.</p>
     *
     * @param srcNumber - 숫자집합
    ...
    /**
     * <p>int형 amount 를 String 문자열로 변경한다.</p>
     *
     * @param amount String 으로 변경할 int
     * @return String 결과값
     */
    ...
    /**
     * <p>Double형 amount 를 String 문자열로 변경한다.</p>
     *
     * @param amount String 으로 변경할 double
     * @return String 결과값
     */
    ...
    /**
     * <p>long형 amount 를 String 문자열로 변경한다.</p>
     *
     * @param amount String 으로 변경할 long
     * @return String 결과값
     */
    ...
    /**
     * <p>BigDecimal형 amount 를 String 문자열로 변경한다.<p>
     *
     * @param amount String 으로 변경할 BigDecimal
     * @return String 결과값
     */
