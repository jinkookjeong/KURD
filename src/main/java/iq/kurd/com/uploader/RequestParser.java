...
public class RequestParser
{
    ...
    public static RequestParser getInstance(HttpServletRequest request, MultipartUploadParser multipartUploadParser) throws Exception
    {
        ...
        if (multipartUploadParser == null)
        {
            ...
            {	
                ...
                //System.out.println("FILENAME_PARAM: "+requestParser.filename );
    ...
    {
    	//System.out.println("uuid 1:"+requestParser.uuid );
        ...
        if (requestParser.originalFilename == null)
        {
            ...
            //System.out.println("originalFilename 1:"+requestParser.originalFilename );
        }
        
        //System.out.println("uuid 2:"+requestParser.uuid );
    }
